...
public class ExcelUtility {
	...
	public String getDataFromExcel(String sheetName , int rowNum , int celNum) throws Throwable {
		...
		FileInputStream fis = new FileInputStream("./testdata/FlieBend.xlsx");
		...
		public String getDateDataFromExcel(String sheetName , int rowNum , int celNum) throws Throwable {
			
			FileInputStream fis = new FileInputStream("./testdata/FlieBend.xlsx");
			Workbook wb =  WorkbookFactory.create(fis);
		    String data = wb.getSheet(sheetName).getRow(rowNum).getCell(celNum).getLocalDateTimeCellValue().toString().substring(0, 10).toString();
	...
	public void setDataIntoExcel(String sheetName , int rowNum , int celNum , String data) throws EncryptedDocumentException, IOException {
		...
		FileOutputStream fos = new FileOutputStream("./testdata/FlieBend.xlsx");
		wb.write(fos);
		wb.close();
	} 
